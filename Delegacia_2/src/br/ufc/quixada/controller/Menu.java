...
public class Menu {
	...
	public Crime buscaGeralBoletim() {
		...
		if(c == 1) {
			...
			int l = sc.nextInt(); sc = new Scanner(System.in);
			crimeAtual = buscaBoletimID(l);
			CrimeDAO.buscar(l);
			
			System.out.println("Busca concluida\n\nE - Editar\tR - Remover\t0 - Sair");
			sc = new Scanner(System.in);
			String ler0 = sc.nextLine(); sc = new Scanner(System.in); sc = new Scanner(System.in);
			
			switch (ler0) {
			case "E":
				
				CrimeDAO.editar(CrimeDAO.buscar(Integer.valueOf(l)));
		...
		if(c == 2) {
			...
			ArrayList<Crime> crimes = CrimeDAO.buscar(ler);
			
			for(int i = 0; i < crimes.size(); i++) {
				System.out.println(crimes.toString());
				System.out.println("dfjdfgh");
			}
			...
			case "E":
				...
				ler = sc.nextLine(); sc = new Scanner(System.in); sc = new Scanner(System.in);
				CrimeDAO.editar(CrimeDAO.buscar(Integer.valueOf(ler)));
				System.out.println("Edicao feita com sucesso");
				return null;
	...
	public Criminoso receberCriminoso() {
		...
		System.out.println("Digite o codigo do suspeito\tou\tC - Cadastrar novo suspeito");
		String newId = sc.nextLine(); sc = new Scanner(System.in);
